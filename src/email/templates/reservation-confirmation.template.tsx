          ...
          >
            ...
            <div style={{ padding: '40px 30px' }}>
              ...
              >
                ...
                >
                  Your reservation is ready and confirmed
                </p>
              </div>
                ...
                >
                  <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    <tbody>
                      {/* Selected Nights */}
                      <tr>
                        <td style={{ padding: '8px 0', color: '#6A6A6A' }}>
                          Selected:
                        </td>
                        <td
                          style={{
              ...
              >
                <div style={{ textAlign: 'center', marginBottom: '15px' }}>
                  <div
                    style={{
                      ...
                      margin: '0 auto',
                      border: '2px solid #7FB069',
                      backgroundImage: hostAvatarUrl
                        ? `url(${hostAvatarUrl})`
                        : 'none',
                      backgroundColor: hostAvatarUrl
                        ? 'transparent'
                        : '#7FB069',
                ...
                <p style={{ margin: '0', color: '#6A6A6A', fontSize: '16px' }}>
                  {hostName}
                </p>
                <p
                  style={{
              ...
              <div style={{ textAlign: 'center', margin: '30px 0' }}>
                <a
                  href={`${frontendUrl}/profile/reservations?id=${reservationId}`}
                  style={{
                    display: 'inline-block',
                    backgroundColor: '#7FB069',
                    color: 'white',
